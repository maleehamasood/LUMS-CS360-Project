...
class CheckAllIssuesScreen extends StatefulWidget {
  var employee;

  @override
  State<StatefulWidget> createState() {
    return _CheckAllIssuesScreenState(this.employee);
  }

  CheckAllIssuesScreen(this.employee);
}

class _CheckAllIssuesScreenState extends State<CheckAllIssuesScreen> {
  var employee;
  ...
  _CheckAllIssuesScreenState(this.employee) {
    _getAllInCityIssues(this.employee);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: _appBar("Check all issues"),
  ...
  _getAllInCityIssues(String employee) {
    AppServices.getAllInCItyIssues(employee).then((allIssuesEver) {
      setState(() {
  ...
  Widget _issueList(BuildContext context, double height, double width) {
    ...
    if (arrayOfIssues.length > 0) {
      return ListView.builder(
          itemCount: arrayOfIssues.length - 1,
