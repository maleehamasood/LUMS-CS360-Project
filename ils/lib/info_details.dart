...
class Info extends StatelessWidget {
  ...
  List<Widget> _renderTitle(BuildContext context, String text) {
    ...
    result.add(
        _sectionText("Displays a the current role of the adjacent employee."));
    result.add(_sectionsubTitle("On selection"));
    result.add(_sectionText(
        "Clicking on one of these tiles will lead to you a new screen with specific details about your chosen function"));
