...
class InfoAssign extends StatelessWidget {
  @override
  ...
  List<Widget> _renderTitle(BuildContext context, String text) {
    ...
    result.add(_sectionText(
        "This feature allows the admin to assign an issue to a relevant support team member"));
    result.add(_sectionsubTitle("Name"));
    result.add(_sectionText(
        "Displays a list of names of all employees of which the team can be changed."));
    ...
    result.add(_sectionsubTitle("Assign"));
    result.add(_sectionText(
        "The update button at the end of the screen allows the user to assign the issue to the relevant employee."));
