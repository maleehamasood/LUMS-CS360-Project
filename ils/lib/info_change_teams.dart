...
class InfoTeams extends StatelessWidget {
  ...
  List<Widget> _renderTitle(BuildContext context, String text) {
    ...
    result.add(_sectionText(
        "This feature allows the admin to change the support team of employees."));
    ...
    result.add(_sectionText(
        "The update button at the end of the screen allows the user to update the team of a certain employee."));
