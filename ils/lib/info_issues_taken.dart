...
class Info extends StatelessWidget {
  ...
  List<Widget> _renderTitle(BuildContext context, String text) {
    ...
    result.add(_sectionText(
        "This feature displays the status and details of all issues currently taken up by a user"));
    ...
    result.add(_sectionText(
        "Clicking on one of these issue cards will lead you to a new screen where information of an issue is listed in detail."));
    result.add(_sectionsubTitle("Update"));
    result.add(_sectionText(
        "The update button at the end of the screen allows the user to update the status of the issue chosen. It can change the status of the issue to fixed or closed."));
