...
class Info extends StatelessWidget {
  ...
  List<Widget> _renderTitle(BuildContext context, String text) {
    ...
    result.add(_sectionText(
        "This feature allows managers to monitor the issues taken up by the respective team under working for him."));
    ...
    result.add(_sectionsubTitle("Reassign"));
    result.add(_sectionText(
        "The reassign button at the end of the page allows you to reassign the issue to another support team member."));
